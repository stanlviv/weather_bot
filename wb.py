...
jokes = {
    ...
    11: 'І про погоду: завтра очікується волога погода з рясними соплями, температура до 40 градусів, пориви кашлю можуть досягати 5-7 метрів.',
    12: 'Уже декілька днів іде дощ. У моєї жінки сильна депресія, вона стоїть і постійно дивиться у вікно. Якщо і далі буде йти дощ, доведеться впустити її в всередину.',
}
